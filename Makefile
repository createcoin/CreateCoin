#############################################################################
# Makefile for building: CreateCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? ?? 5 21:12:13 2014
# Project:  CreateCoin-qt.pro
# Template: app
# Command: h:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile CreateCoin-qt.pro
#############################################################################
...
MAKEFILE      = Makefile
QMAKE         = h:\Qt\4.8.5\bin\qmake.exe
DEL_FILE      = del
...
Makefile: CreateCoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
		...
		h:/Qt/4.8.5/lib/qtmain.prl \
		h:/Qt/4.8.5/lib/QtGui.prl \
		h:/Qt/4.8.5/lib/QtNetwork.prl \
		h:/Qt/4.8.5/lib/QtCore.prl
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile CreateCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) H:/X13CreateCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) H:/X13CreateCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
H:/X13CreateCoin/src/leveldb/libleveldb.a: FORCE
